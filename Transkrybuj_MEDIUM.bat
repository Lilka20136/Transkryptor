@echo off
chcp 65001 >nul
rem Transkrypcja modelem MEDIUM (dokladniejszy, ale duzo wolniejszy; potrzebuje ok. 5 GB wolnego RAM).
rem Przed uruchomieniem zamknij Chrome/Teams/Outlook. Dwuklik = folder 'do_transkrypcji'.
